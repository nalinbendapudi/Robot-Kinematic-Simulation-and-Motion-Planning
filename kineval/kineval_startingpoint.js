...
kineval.startingPlaceholderInit = function startingPlaceholderInit() {
    ...
    */
    ...
    spacingGlobal = 0.9;  // variables not declared with "var" are global
...
kineval.startingPlaceholderUserInput = function startingPlaceholderUserInput() {
    ...
    */
    ...
    // STENCIL: update the global spacing variable
        ...
        textbar.innerHTML = "Whether we are based on carbon or on silicon makes no fundamental difference; we should each be treated with appropriate respect. ― Arthur C. Clarke, 2010: Odyssey Two"; 
    }
}
